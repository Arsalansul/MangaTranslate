...
class Region(BaseModel):
    ...
    keep_lines: bool = Field(
        False,
        description="Разбиение на строки смысловое, а не перенос по ширине: "
                    "список, содержание, титры. У такого текста text приходит "
                    "с переносами, перевод обязан их сохранить, а вёрстка — "
                    "выключить по левому краю, а не по центру.",
    )
